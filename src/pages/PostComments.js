          ...
          <>
            <Grid.Row columns={4}>
              <Grid.Column style={{ minWidth: '50%' }} >
                <p style={{ textAlign: 'left', fontFamily: 'Raleway', fontSize: '20px', fontWeight: '500', whiteSpace: 'pre-wrap', overflowWrap: 'break-word' }} onMouseOver={() => { updateViewCount(comment["id"]); }}>{comment["content"]}</p>
              </Grid.Column>
